...
So far students would have to check their solutions to coding exercises by assessing whether the output is reasonable or comparing their code to the solution. The [**gradethis**](https://pkgs.rstudio.com/gradethis/articles/gradethis.html) package has functions for automated feedback on code.
...
```
## Part 7: Recording responses with learnrhash

The [**learnrhash**](https://github.com/rundel/learnrhash) package makes it feasible to collect student responses to learnr tutorials. Students submit their responses using a "hash" submitted to an online form.
